...
/*   Updated: 2024/06/07 18:56:49 by ademarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	comp->x = ((x * (fractal->x_max - fractal->x_min) / WIDTH) + fractal->x_min) * fractal->zoom + fractal->move_x;
	comp->y = ((y * (fractal->y_max - fractal->y_min) / HEIGHT) + fractal->y_min) * fractal->zoom + fractal->move_y;
	return (*comp);
}
